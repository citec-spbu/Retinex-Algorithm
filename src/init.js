...
function setupUniformLocations() {
    ...
    WebGLContext.sigmaLocation = WebGLContext.gl.getUniformLocation(WebGLContext.program, "u_sigma1");
    WebGLContext.sigmaLocation = WebGLContext.gl.getUniformLocation(WebGLContext.program, "u_sigma2");

    WebGLContext.sigmaLocation = WebGLContext.gl.getUniformLocation(WebGLContext.program, "u_sigma3");
